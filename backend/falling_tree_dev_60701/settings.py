"""
Django settings for falling_tree_dev_60701 project.
...
ROOT_URLCONF = 'falling_tree_dev_60701.urls'
...
WSGI_APPLICATION = 'falling_tree_dev_60701.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_tree_dev_60701 API",
    "DESCRIPTION": "API documentation for falling_tree_dev_60701 App",
    "VERSION": "v1",
}
